...
const PAGES: Record<string, any> = {
  ...
  'best-laptop-deals': {
    ...
    intro: "Laptops are one of the biggest purchases most people make. Our editors verify every laptop deal — checking that the discount is real, the model is current, and the seller is reputable.",
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://daily.deals/topic/${params.slug}` },
    openGraph: {
      type: 'website',
      title: config.title,
      description: config.description,
      url: `https://daily.deals/topic/${params.slug}`,
    },
  }
}
